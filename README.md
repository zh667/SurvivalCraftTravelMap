...
- 小地图：默认逻辑尺寸为 `160`，显示已探索地形、玩家方向、坐标点、可选 XYZ 坐标和可选生物标记。支持“北方朝上”和“行进方向朝上”；后者会围绕玩家旋转地形、生物和路标，同时让玩家箭头保持朝上。罗盘的北方与其他方向可独立开关并调整字号。捕食者、鸟类和其他生物分别显示为红、黄、绿色，死亡生物和玩家自己不会作为生物标记出现。可从设置进入放置模式，用鼠标或触摸拖动并确认位置；位置以归一化坐标持久化，并随窗口尺寸和 UI 缩放安全夹紧。单击小地图或按 `M` 均可打开大地图。
...
- 右键坐标点：传送、重命名或删除。
- 大地图“设置”：开关小地图、坐标、生物标记、罗盘北方、罗盘其他方向、固定北方朝上、日夜明暗和邀请；调整生物标记大小、罗盘字号、小地图尺寸与两种地图缩放，并可进入小地图位置调整。大地图本身始终保持北方朝上。
