...
public sealed class SurvivalcraftTerrainMapSource(SubsystemTerrain terrain) : ITerrainMapSource
{
        ...
        out Rgba32 color)
    {
        ...
        switch (content)
        {
            case 8:
            case 19:
                gameColor = BlockColorsMap.GrassColorsMap.Lookup(temperature, humidity);
                break;
            case 12:
                gameColor = BlockColorsMap.OakLeavesColorsMap.Lookup(temperature, humidity);
                break;
            case 13:
                gameColor = BlockColorsMap.BirchLeavesColorsMap.Lookup(temperature, humidity);
                break;
            case 14:
                gameColor = BlockColorsMap.SpruceLeavesColorsMap.Lookup(temperature, humidity);
                break;
            case 18:
                gameColor = BlockColorsMap.WaterColorsMap.Lookup(temperature, humidity);
                break;
            case 225:
                gameColor = BlockColorsMap.TallSpruceLeavesColorsMap.Lookup(temperature, humidity);
                break;
            case 256:
                gameColor = BlockColorsMap.MimosaLeavesColorsMap.Lookup(temperature, humidity);
                break;
            default:
                color = default;
                return false;
